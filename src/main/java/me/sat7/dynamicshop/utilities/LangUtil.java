...
//        }
        ...
        // 영어
        {
            ...
            ccLang.get().addDefault("START_PAGE.DEFAULT_SHOP_LORE", "&6[Click to open this category]");
            ...
            ccLang.get().addDefault("SHOP.TRADE_LORE", "&6[Click to buy/sell this items]");
            ccLang.get().addDefault("SHOP.BUY_PRICE", "&6✚ &fBuy price:/   &a${num} &e┃ per piece");
            ccLang.get().addDefault("SHOP.SELL_PRICE", "&6✚ &fSell price:/   &c${num} &e┃ per piece");
            ccLang.get().addDefault("SHOP.STOCK", "&6✚ &fStocks:/   &7{num} pieces");
            ...
            ccLang.get().addDefault("ITEM_SETTING.BUY", "&6✚ &fBuy price:/   &a${num} &e┃ per piece");
            ccLang.get().addDefault("ITEM_SETTING.SELL", "&6✚ &fSell price:/   &c${num} &e┃ per piece");
    ...
    {
        String temp = ChatColor.translateAlternateColorCodes('&', ccLang.get().getString(key));
